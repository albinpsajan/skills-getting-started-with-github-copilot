...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball team for intramural and league competitions",
    ...
    "Music Band": {
        "description": "Learn and perform various instruments in an ensemble",
    ...
    "Science Club": {
        "description": "Explore scientific principles through experiments and research",
